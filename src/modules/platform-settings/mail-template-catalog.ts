...
const definitions: Record<MailTemplateKey, MailTemplateDefinition> = {
  ...
  STANDARD_REQUEST_CUSTOMER_UPDATE: {
    ...
    variables: [
      { key: "recipientName", label: "收件人姓名", sample: "张三" },
      { key: "requestNumber", label: "工单编号", sample: "SR-20260721-001" },
      { key: "requestTitle", label: "工单标题", sample: "接口调用异常" },
      { key: "projectName", label: "项目名称", sample: "API 服务支持" },
      { key: "notificationTitle", label: "更新标题", sample: "技术支持回复了工单" },
  ...
  STANDARD_REQUEST_STAFF_UPDATE: {
    ...
    name: "标准工单后台未读提醒",
    description: "处理人持续未查看客户回复或新工单时发送。",
    variables: [
  ...
  STANDARD_REQUEST_ASSIGNMENT: {
    ...
    name: "标准工单处理人分配提醒",
    description: "用户被分配为新的工单处理人且持续未查看时发送。",
    variables: [
    ...
    defaults: {
      ...
      heading: "你好，{{recipientName}}",
      body: "你已被分配处理“{{requestTitle}}”。请进入 {{projectName}} 查看工单详情并开始处理。",
      actionLabel: "处理服务请求",
    },
  },
  STANDARD_PROJECT_CUSTOMER_UPDATE: {
